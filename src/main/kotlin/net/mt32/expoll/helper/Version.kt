...
import net.mt32.expoll.VersionDescriptor
import net.mt32.expoll.config
import net.mt32.expoll.routes.Compliance
...
fun versionsMatchExact(version1: VersionDescriptor, version2: Compliance): Boolean{
    return compareVersion(version1, version2) == 0
}

fun versionMatchRange(from: VersionDescriptor?, to: VersionDescriptor?, toCheck: Compliance): Boolean{
